package dev.gaphunter.kafkatopicfeedbackloopcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.kafkatopicfeedbackloopcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.kafkatopicfeedbackloopcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Kafka Topic Feedback-Loop Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34067-kafka-topic-feedback-loop-companion/reviews"
